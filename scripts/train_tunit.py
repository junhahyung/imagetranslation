...
parser.add_argument('--dataconfig', help='data configuration')
...
def main():
    ...
    if args.multiprocessing_distributed:
        ...
        mp.spawn(main_worker, nprocs=ngpus_per_node, args=(ngpus_per_node, args, dataconfig))
    else:
        main_worker(args.gpu, ngpus_per_node, args, dataconfig)


def main_worker(gpu, ngpus_per_node, args, dataconfig):
    if len(args.gpu) == 1:
        args.gpu = 0
    else:
        args.gpu = gpu
