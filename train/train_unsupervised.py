...
from utils.ops_tunit import compute_grad_gp, update_average, copy_norm_params, calc_iic_loss, \
...
def trainGAN_UNSUP(data_loader, networks, opts, epoch, args, additional):
    ...
    for i in t_train:
        ...
        x_org = x_org.cuda(args.gpu).detach()
        x_tf = x_tf.cuda(args.gpu).detach()
